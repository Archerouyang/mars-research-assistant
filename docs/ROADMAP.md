...
| Broker-live position daily report script | Started | `plugins/trading-research-system/scripts/position_daily_report.py`; `plugins/trading-research-system/scripts/verify_position_daily_report_selftest.py`; fixture `position-daily-report.md` |
