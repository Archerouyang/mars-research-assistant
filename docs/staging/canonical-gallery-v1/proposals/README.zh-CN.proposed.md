...
详细文档：[Skill 契约](skills/trading-research-system/SKILL.md)、[工作流设计](docs/PLUGIN_DESIGN.md)、[MVP Runbook](docs/MVP_RUNBOOK.md) 和[分发决策](docs/adr/0007-command-first-agent-skill-distribution.md)。
