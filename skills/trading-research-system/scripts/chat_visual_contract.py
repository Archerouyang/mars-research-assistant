#!/usr/bin/env python3
"""Small shared contract for purpose-specific chat visual adapters."""
...
class ChatVisualError(ValueError):
    """Fail-closed chat visual error with a stable public code."""


@dataclass(frozen=True)
class ChatVisualAdapter:
