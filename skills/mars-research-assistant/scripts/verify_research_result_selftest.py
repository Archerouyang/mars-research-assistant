...
def main() -> int:
    ...
    require(b'mars-research-assistant-macro-board-' in first.standalone_board.html, "macro Board identity missing")
    ...
    pa_manifest = json.loads(pa_packet.standalone_board.manifest)
    require(pa_manifest["views"] == ["bull", "base", "bear"], "price action view order changed")
    require(pa_manifest["default_view"] == "base", "price action default view changed")
