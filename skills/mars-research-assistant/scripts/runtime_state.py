#!/usr/bin/env python3
"""Shared Runtime State helpers for private Mars Research Assistant files."""
...
DEFAULT_RUNTIME_RELATIVE = Path("Documents") / "mars-research-assistant-runtime"
...
def template_dir_from_script(script_path: str | Path) -> Path:
    """Return the Skill assets/templates directory for a script path."""
