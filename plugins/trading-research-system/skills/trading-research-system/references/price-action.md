...
The chat-inline chart is the primary output. Put the chart and key levels before
long prose.

## Frozen 0.2.0 Inline Template

The user accepted the native PA template on 2026-07-19. Keep this information
hierarchy stable for the 0.2.0 release:
...
image, keep the accepted inline HTML as the source and run
`scripts/export_inline_png.mjs` to create a full-content PNG. Do not auto-save,
