...
Use this reference when monitoring current-day trade plans for planned setups.

The intraday scanner is a decision-support workflow. It does not discover unplanned trades, place orders, or turn price alerts into buy/sell instructions.
