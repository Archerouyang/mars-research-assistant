        ...
        files={
            "reference": FileContract(
                ...
                required_terms=(
                    ...
                    "KVN rows are ticker-level rows only",
                    ...
                    "The agent must not re-rank, re-score, or reorder KVN rows",
                    "scheduled or upstream script",
            ...
            "focused skill": FileContract(
                ...
                required_terms=(
                    ...
                    "Top10",
                    "ticker-only",
                    "no sectors, themes, or narrative buckets",
                    "must not re-rank, re-score, or reorder",
                    "scheduled or upstream script",
                    "query",
                    "changes",
                    "research priority only, not a buy list",
            ...
            "daily skill": FileContract(
                ...
                required_terms=(
                    "KVN Momentum Leaderboard",
                    "ticker-only",
                    "sector/theme rotation belongs in market breadth",
                    "must not re-rank, re-score, or reorder KVN rows",
                    "runtime-health.md",
            ...
            "daily template": FileContract(
                ...
                required_terms=(
                    ...
                    "Do not re-rank or re-score KVN",
