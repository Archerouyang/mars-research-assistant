...
REQUIRED = {
    "script": [
        ...
        "passed integrity and activation checks",
        "No private broker, plan, note, or credential contents were read.",
        "--broker-source",
        "--source-capability",
        "--stale-after-days",
    ],
    "selftest": [
        ...
        "manual_snapshot_source",
        "live read-only",
        "Alpha runtime readiness was not verified",
    ],
    "reference": [
        "# Runtime Health",
        "available",
        ...
        "manual snapshot",
        "dry-run",
        "Do not read or copy private broker, plan, note, or credential contents",
        "runtime_health.py",
        "market-plan.md",
        "trading-profile.md",
        "kvn.sqlite",
