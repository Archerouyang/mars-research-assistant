#!/usr/bin/env python3
"""Self-test the canonical position report rendering fixture.

Reconciliation mode and broker-composition behavior is covered by the
repo-level Behavior Contract Matrix gate.
"""
...
def main() -> int:
    ...
    if actual != expected:
        raise AssertionError(
            f"position daily report mismatch\nEXPECTED:\n{expected}\n\nACTUAL:\n{actual}"
        )
