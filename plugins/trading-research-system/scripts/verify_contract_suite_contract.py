...
REQUIRED = {
    "contract_suite": [
        ...
        "verify_alpha_leaderboard_adapter_selftest.py",
        "verify_alpha_leaderboard_adapter_contract.py",
        ...
        "verify_macro_regime_board_selftest.py",
    ...
    "selftest": [
        ...
        "emit_output=False",
        "source-routing",
        "alpha-leaderboard-adapter-contract",
        "analysis-delta-adapter-contract",
        "alpha-automations",
        "macro-data-source",
        "longbridge-skill-adapter",
        "broker-snapshot-ingest-contract",
        "instrument-research-board-selftest",
        "macro-regime-board-selftest",
    ],
    "verify_plugin": [
